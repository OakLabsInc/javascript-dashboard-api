...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dashboard.WifiConfiguration();
  });
  ...
  describe('WifiConfiguration', function() {
    it('should create an instance of WifiConfiguration', function() {
      // uncomment below and update the code to test WifiConfiguration
      //var instance = new dashboard.WifiConfiguration();
      //expect(instance).to.be.a(dashboard.WifiConfiguration);
    });
