...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dashboard.DisplayGlobalConfiguration();
  });
  ...
  describe('DisplayGlobalConfiguration', function() {
    it('should create an instance of DisplayGlobalConfiguration', function() {
      // uncomment below and update the code to test DisplayGlobalConfiguration
      //var instance = new dashboard.DisplayGlobalConfiguration();
      //expect(instance).to.be.a(dashboard.DisplayGlobalConfiguration);
    });
