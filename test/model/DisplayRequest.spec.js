...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dashboard.DisplayRequest();
  });
  ...
  describe('DisplayRequest', function() {
    it('should create an instance of DisplayRequest', function() {
      // uncomment below and update the code to test DisplayRequest
      //var instance = new dashboard.DisplayRequest();
      //expect(instance).to.be.a(dashboard.DisplayRequest);
    });
