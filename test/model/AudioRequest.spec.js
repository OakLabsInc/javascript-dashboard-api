...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dashboard.AudioRequest();
  });
  ...
  describe('AudioRequest', function() {
    it('should create an instance of AudioRequest', function() {
      // uncomment below and update the code to test AudioRequest
      //var instance = new dashboard.AudioRequest();
      //expect(instance).to.be.a(dashboard.AudioRequest);
    });

    it('should have the property mixerId (base name: "mixer_id")', function() {
      // uncomment below and update the code to test the property mixerId
      //var instance = new dashboard.AudioRequest();
