...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new dashboard.AuthApi();
  });
  ...
  describe('AuthApi', function() {
    describe('jwtValidate', function() {
      it('should call jwtValidate successfully', function(done) {
        //uncomment below and update the code to test jwtValidate
        //instance.jwtValidate(function(error) {
