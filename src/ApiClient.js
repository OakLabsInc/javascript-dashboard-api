...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.dashboard.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://dashboard.oak.host/api/v5
     */
    this.basePath = 'https://dashboard.oak.host/api/v5'.replace(/\/+$/, '');
